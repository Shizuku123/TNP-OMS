...
if (!$input || !isset($input['staffId']) || !isset($input['adminPassword'])) {
...
if ($xmlHandler->deleteStaff($input['staffId'])) {
    echo json_encode(['success' => true, 'message' => 'Staff record deleted successfully']);
} else {
